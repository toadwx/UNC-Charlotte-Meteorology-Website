  	...
  	function liveStn()
  	{
	    ...
	    $.ajax({   
	      ...
	      success: function(data)          //on recieve of reply
	      {
	        ...
	        document.getElementById("T").innerHTML = outTemp + "&#176;F <span><img src='http://weather.uncc.edu/data/stnplot/daytempdew.png' width='100%' alt=''></span>";
	        document.getElementById("WC").innerHTML = wndchl + "&#176;F <span><img src='http://weather.uncc.edu/data/stnplot/daytempchill.png' width='100%' alt=''></span>";
	        document.getElementById("HI").innerHTML = htindx + "&#176;F <span><img src='http://weather.uncc.edu/data/stnplot/heatindex.png' width='100%' alt=''></span>";
	        document.getElementById("Td").innerHTML = dewpoint + "&#176;F <span><img src='http://weather.uncc.edu/data/stnplot/daytempdew.png' width='100%' alt=''></span>";
	        document.getElementById("RH").innerHTML = RH + "%";
	        document.getElementById("p").innerHTML = barometer + " mb <span><img src='http://weather.uncc.edu/data/stnplot/daybarometer.png' width='100%' alt=''></span>";
	        document.getElementById("w").innerHTML = wndspd + " mph from " + wnddir + "<span><img src='http://weather.uncc.edu/data/stnplot/daywind.png' width='100%' alt=''></span>";
	        document.getElementById("rr").innerHTML = rainRate + " in/hr <span><img src='http://weather.uncc.edu/data/stnplot/dayrain.png' width='100%' alt=''></span>";
	        document.getElementById("UV").innerHTML = UV + "<span><img src='http://weather.uncc.edu/data/stnplot/dayuv.png' width='100%' alt=''></span>";
	        document.getElementById("sun").innerHTML = radia + " W/m&#178; <span><img src='http://weather.uncc.edu/data/stnplot/dayradiation.png' width='100%' alt=''></span>";
